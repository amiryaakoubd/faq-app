...
describe('Home Page', () => {
  ...
  it('renders accordion items when there are no errors', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Hvem er Nova Consulting Group?')).toBeInTheDocument();
  ...
  it('renders error message when there is an error', async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText('Noe gikk galt under henting av data. Vennligst prøv igjen senere.'),
      ).toBeInTheDocument();
    });
  });
